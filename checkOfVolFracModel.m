...
ver_one = volFracModel(sel,r,E,CAone,sidenum_3x3);
ver_two = volFracModel(sel,r,E,CAtwo,sidenum_3x3);
...
ver_three = volFracModel(sel,r,E,CAthree,sidenum_5x5);
ver_four = volFracModel(sel,r,E,CAfour,sidenum_5x5);

% Input Constants (4x4)
sidenum_4x4 = 4; % Number of nodes on each size of square grid
nucFac_4x4 = 3; % factor to indicate how many unit cells are in this model

% Input trial connectivity arrays (4x4)
CAfive = [1,2;2,3;3,4;4,8;8,12;12,16;15,16;14,15;13,14;9,13;5,9;1,5;
      2,6;6,10;10,14;3,7;7,11;11,15;5,6;6,7;7,8;9,10;10,11;11,12;
      1,6;2,7;3,8;5,10;6,11;7,12;9,14;10,15;11,16];

% Check constraints for all trial truss designs (4x4)
ver_five = volFracModel(sel,r,E,CAfive,sidenum_4x4);

% Input Constants (5x5 v2)
sidenum_5x5 = 5; % Number of nodes on each size of square grid
nucFac_5x5 = 4; % factor to indicate how many unit cells are in this model

% Input trial connectivity arrays (5x5 v2)
CAsix = [1,2;2,3;3,4;4,5;5,10;10,15;15,20;20,25;24,25;23,24;22,23;21,22;
...
% Check constraints for all trial truss designs (5x5 v2)
ver_six = volFracModel(sel,r,E,CAsix,sidenum_5x5);

%----------------------%
% FUNCTION TO CALCULATE C-VALUES VIA VOLUME FRACTION METHOD
function Cval=volFracModel(sel,r,E,CA,sidenum)
    % Generate nodal grid
